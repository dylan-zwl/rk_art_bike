...
public class CvaVideo {
	...
	enum VaLanguage {
		VAL_DEFAULT, VAL_ENGLIASH, VAL_ITALIAN, VAL_DUTCH, VAL_PORTUGUESE, VAL_CHINESE_SIMPLIFIED, VAL_SPANISH, VAL_CHINESE_TRADITIONAL, VAL_GERMAN8, VAL_JANPANESE, VAL_FRENCH
	};
